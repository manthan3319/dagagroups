        ...
        <div>
            <div className='lg:max-w-[1440px] px-[20px] m-auto py-[50px]'>
                <div className='text-center'>
                    <h1 className='font-tomorrow sm:text-[45px] text-[35px] font-bold pb-[10px] border-b-[1px] inline-block'>Careers At Daga Groups</h1>
                </div>
                ...
                <div className='flex md:flex-row flex-col gap-[30px] py-[80px] lg:w-[70%] w-[100%] m-auto items-center'>
                    ...
                    <div className='flex flex-col gap-[25px]'>
                        <p className='text-[20px] font-roboto'>At Daga Groups, we believe in nurturing talent and fostering innovation. Join us and be a part of an environment where your skills are valued, and your growth is a priority.</p>
